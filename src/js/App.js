...
const routeParams = routeParamsBuilder(
    ServiceFactory.global().configurationService().all()
);
...
class App extends React.Component {
    ...
    componentDidMount() {
        const isBrowserSupported = ServiceFactory.global()
            .browserService()
        ...
        return (
            <React.Fragment>
                <div className={wrapperClassName}>
                    ...
                    <div className="container grid">
                        ...
                        <Switch>
                            <Route
                                exact
                                path={routes.blocks.one(
                                    routeParams.blockHeight
                                )}
                            ...
                            <Route
                                exact
                                path={routes.aliases.one(routeParams.alias)}
                                component={SingleAliasPage}
                            />
                            <Route
                                exact
                                path={routes.assets.one(routeParams.assetId)}
                ...
                <div className="mobile-menu">
                    ...
                    <NavBar
                        appearance="mobile"
                        onAfterNavigate={this.handleMobileMenuToggle}
                    />
                </div>
